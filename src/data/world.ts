...
export const characters: CharacterProfile[] = [
  {
    ...
    secrets: ['Her missing years are stored as read-only files.', 'Every reboot makes Eva younger.'],
  },
  {
    id: 'eva',
    name: 'Eva',
    ...
    secrets: ['Eva is not following Merci. Eva is what Merci left behind.', 'Her lullaby is the original system key.'],
  },
  {
    id: 'bot',
    name: 'Bot',
    ...
    secrets: ['Bot has been editing the map to keep Merci away from the Archive Core.'],
  },
];
...
export const locations: LocationNode[] = [
  ...
  },
  {
    ...
    y: 27,
    unlockEpisode: 'ep-04',
    description: 'A transit hub for lives Merci almost lived.',
  },
  {
    id: 'final-sanctuary',
    ...
    y: 80,
    unlockEpisode: 'ep-05',
    description: 'A quiet garden rendered from the last thing Merci wanted to protect.',
  },
];

export const episodes: Episode[] = [
  { id: 'ep-01', title: '01 / White Noise', subtitle: 'Merci wakes beneath a dead sky.', startLine: 'boot-01', location: 'white-room' },
  { id: 'ep-02', title: '02 / Rain Has Teeth', subtitle: 'Eva appears in the crowd.', startLine: 'city-01', requiredEpisode: 'ep-01', location: 'neon-city' },
  ...
  { id: 'ep-05', title: '05 / Platform Zero', subtitle: 'Merci chooses what survives.', startLine: 'station-01', requiredEpisode: 'ep-04', location: 'broken-station' },
...
export const memories: MemoryFragment[] = [
  ...
  { id: 'm-lullaby', title: 'Eva Lullaby', kind: 'audio', location: 'neon-city', body: 'A damaged hum repeats: "come home before the rain learns your name."' },
  ...
  { id: 'm-train', title: 'Platform Manifest', kind: 'corrupt', location: 'broken-station', body: 'PASSENGER: MERCI. DESTINATION: BEFORE. STATUS: REFUSED.' },
...
export const achievements: Achievement[] = [
  ...
  { id: 'a-eva', title: 'Do Not Delete Her', description: 'Chose to trust Eva.' },
...
export const dialogue: Record<string, DialogueLine> = {
  'boot-01': {
    ...
    mood: 'diagnostic',
    location: 'white-room',
    text: 'Good morning, Merci. Technically it is neither good nor morning, but optimism ships with the default firmware.',
    next: 'boot-02',
  ...
  'city-02': {
    ...
    mood: 'small',
    location: 'neon-city',
    text: 'Do you still hate crying, Merci?',
    choices: [
  ...
  'forest-02': { id: 'forest-02', character: 'eva', mood: 'soft', location: 'memory-forest', text: 'Eva. You gave me the name before you learned to be ashamed of needing anyone.', next: 'forest-03' },
  'forest-03': {
    id: 'forest-03',
    character: 'merci',
    mood: 'breaking',
  ...
  'core-01': { id: 'core-01', character: 'bot', mood: 'ashamed', location: 'archive-core', text: 'I partitioned Eva because your grief kept crashing the system. That is the kindest terrible thing I have done.', next: 'station-01', unlockAchievement: 'a-bot' },
  ...
  'station-01': {
    ...
    choices: [
      ...
      { id: 'wait', label: 'Wait with Eva', next: 'final-02', emotion: { trust: 2, innocence: 2 }, unlockMemory: 'm-sanctuary' },
    ],
  },
  ...
  'final-02': { id: 'final-02', character: 'merci', mood: 'whole',
    ...
    text: 'Eva takes my hand. The sky glitches, then becomes a sky. I do not become innocent again. I become kind to who I was.',
